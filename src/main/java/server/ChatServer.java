...
public class ChatServer {
    ...
    //start main.java.server
    public void startServer() {
        try {
            ServerSocket serverSocket = new ServerSocket(PORT);
            System.out.println("main.java.server started");
            //wait client connects
            while (true) {
                Socket clientSocket = serverSocket.accept();// tao mot ket noi giua khach hang va main.java.server
